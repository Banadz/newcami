@extends('pages.layout.pagesLayout')
            ...
            <div class="row align-items-end">
                <div class="col-lg-8">
                    <div class="page-header-title">
                        ...
                        <div class="d-inline">
                            <h5>Division</h5>
                            <span>Affiche la liste de(s) division(s) déjà enregistré(s)</span>
                        </div>
                    </div>
                </div>
                <div class="col-lg-4">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header justify-content-between">
                        <h3>Liste de division enregistré</h3>
                        <a class="btn btn-primary pull-right" href="newDivision">Nouveau</a>
                    </div>
                    <div class="card-body">
                            ...
                            <table id="scr-vrt-dt"
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{ $division->LABEL_DIVISION }}</td>
                                        <td>{{ $division->service?->CODE_SERVICE }} | {{ $division->service?->LABEL_SERVICE }}</td>
                                        <td>12</td>
                                        <td>
                                            <div class="table-actions">
                                                <a href="{{ route('getDivision') }}" class="updateDivision"
                                                data-toggle="modal" data-target="#divisionUpdate" title="Modifier">
                                                    <i class="ik ik-edit-2"></i>
                                                </a>
                                                <a href="{{ route('deleteDivision') }}" class="deleteDivision" title="Supprimer"><i class="ik ik-trash-2"></i></a>
    ...
    @section('updateModal')
        {{-- Update Modals --}}
        @include('pages.modals.divisionUpdate')
    @endsection
