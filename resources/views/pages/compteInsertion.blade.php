...
<html class="no-js" lang="en">
    <head>
        ...
        <title>CAMI | Compte - Insertion</title>
                                ...
                                <div class="row align-items-end">
                                    <div class="col-lg-8">
                                        <div class="page-header-title">
                                            ...
                                            <div class="d-inline">
                                                <h5>Compte</h5>
                                                <span>Formulaire d'insertion de nouveau compte</span>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-4">
                            ...
                            <div class="col-md-12">
                                <div class="card">
                                    <div class="card-header justify-content-between">
                                        ...
                                        <a class="btn btn-success pull-right" href="compte">Retour</a>
                                    </div>
                                    <div class="card-body">
                                        <form class="forms-sample"  action="{{ route('insertionCompte') }}" method="POST">
                                            @csrf
                                            <div class="row">
                                                <div class="col-sm-10">
                                                ...
                                                <div class="col-sm-10">
                                                    <div class="form-group">
                                                        ...
                                                        placeholder="Fourniture de bureau" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="row">
