...
<html class="no-js" lang="en">
    <head>
        ...
        <title>CAMI | Article - Modification</title>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control select2" name="compte" target="{{ route('recupCategorie') }}" id="compte">
                                                                                        <option value="{{$article->categorie->compte->COMPTE }}" selected>
                                                                                            {{$article->categorie->compte->COMPTE}} | {{$article->categorie->compte->LABEL_COMPTE}}
                                                                                        </option>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    ...
                                                                                    <select class="form-control select2" name="id_categorie" id="id_categorie" required>
                                                                                        <option value="{{$article->categorie->id }}" class="choiceCategorie" selected>
                                                                                            {{$article->categorie->id}} | {{$article->categorie->LABEL_CATEGORIE}}
                                                                                        </option>
                                                                                        @foreach ($categories as $categorie)
                                                                                        <option value="{{ $categorie->id }}" class="choiceCategorie">
                                                                                            {{ $categorie->id }} | {{$categorie->LABEL_CATEGORIE}}
                                                                                        </option>
                                                                                        @endforeach
                                                                                    </select>
                                                                                </div>
